...
<header id="header" class="alt">
    <div class="logo"><a href="index.html">Matembezi</a></div>
    <a href="#menu">Menu</a>
</header>
...
<nav id="menu">
    <ul class="links">
        ...
        <li><a href="hotels.html">Book Hotel</a></li>
        <li><a href="destinations.html">Safari Packages</a></li>
    </ul>
</nav>
...
<section class="banner full">
    <article>
        ...
        <div class="inner">
            <header>
                <p>Live the Experience with US</p>
                <h2>Matembezi Adventures</h2>
            </header>
        </div>
    </article>
    <article>
...
<header class="align-center">
    <p class="special">Don't miss out!!</p>
